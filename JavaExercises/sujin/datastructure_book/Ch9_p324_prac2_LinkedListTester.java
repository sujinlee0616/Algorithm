...
// 앞의 prac1에서 만든 연결 리스트 클래스 LinkedList<E>의 사용 예 
public class Ch9_p324_prac2_LinkedListTester {
	...
	public static void main(String[] args) {
		...
		Ch9_p311_prac1_LinkedList<Data> list = new Ch9_p311_prac1_LinkedList<Data>(); // 리스트를 생성 
