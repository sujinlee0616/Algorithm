...
import datastructure_book.Ch9_p324_prac2_LinkedListTester.Data;
import datastructure_book.Ch9_p324_prac2_LinkedListTester.Menu;

// 배열 커서로 연결 리스트 만들기 프로그램 

public class Ch9_p342_prac4_AryLinkedListTester {
	static Scanner sc=new Scanner(System.in);
	
	// 데이터 (회원번호 + 이름) 
	static class Data{
		static final int NO = 1; // 번호를 입력 받는지 
		static final int NAME = 2; // 이름을 입력 받는지 
	...
	public static void main(String[] args) {
		...
		Ch9_p333_prac3_AryLinkedList<Data> list=new Ch9_p333_prac3_AryLinkedList<Data>(100);
